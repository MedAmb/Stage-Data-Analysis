...
sys.path.append(os.path.abspath('../External/selenium-twitter-scraper'))
...
while M!='Q':
    ...
    c = input()
    if c == 'y':
        My_scrape.scrape_tweets(scrape_query=query_base)
    print('quitter?')
    M = input()
